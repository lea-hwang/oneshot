    ...
    >
      <div class="shot-wrapper">
        <img
          :src="shotImage"
          alt="image"
          @click="detailOpen(shot.id)"
          class="shot-image mouse-cursor-custom"
        />
      </div>
      <b-card-body>
        ...
        <div class="d-flex justify-content-between me-2">
          <small
            ><router-link
              :to="{ name: 'detail', params: { movieId: shot.movie.pk } }"
              class="text-muted"
        ...
        <div class="d-flex justify-content-between">
          ...
          <div class="me-2">
            <small
              >좋아요 {{ shot.like_cnt }}개 댓글
              {{ shot.comments_cnt }}개</small
            >
          </div>
        </div>
      </b-card-body>
