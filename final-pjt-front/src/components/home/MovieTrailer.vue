<template>
  <div class="position-relative" v-if="hasTrailer">
    <div class="movie-trailer">
      ...
      <router-link
        v-if="movieId"
        :to="{ name: 'detail', params: { movieId: movieId } }"
...
export default {
  ...
  computed: {
    ...
    movieTitle() {
      if (this.movieTrailer.movie.title === undefined) {
        return;
      }
      return this.movieTrailer.movie.title;
    },
    movieId() {
      if (this.movieTrailer.movie.id === undefined) {
        return;
      }
    ...
    hasTrailer() {
      return this.movieTrailer.trailer != "";
    },
  },
};
</script>
